...
// Import modules
const logger = __nccwpck_require__(843);
const queryIssueInfo = __nccwpck_require__(969);
const findLinkedIssue = __nccwpck_require__(7);
const getIssueTimeline = __nccwpck_require__(322);
const minimizeIssueComment = __nccwpck_require__(522);
...
const logger = __nccwpck_require__(37);
...
const yaml = __nccwpck_require__(59);
...
var yaml = __nccwpck_require__(222);
...
var loader = __nccwpck_require__(58);
var dumper = __nccwpck_require__(704);
...
module.exports.Type = __nccwpck_require__(225);
module.exports.Schema = __nccwpck_require__(690);
module.exports.FAILSAFE_SCHEMA = __nccwpck_require__(868);
module.exports.JSON_SCHEMA = __nccwpck_require__(395);
module.exports.CORE_SCHEMA = __nccwpck_require__(814);
module.exports.DEFAULT_SAFE_SCHEMA = __nccwpck_require__(830);
module.exports.DEFAULT_FULL_SCHEMA = __nccwpck_require__(134);
...
module.exports.YAMLException = __nccwpck_require__(604);

// Deprecated schema names from JS-YAML 2.0.x
module.exports.MINIMAL_SCHEMA = __nccwpck_require__(868);
module.exports.SAFE_SCHEMA = __nccwpck_require__(830);
module.exports.DEFAULT_SCHEMA = __nccwpck_require__(134);
...
var common              = __nccwpck_require__(156);
var YAMLException       = __nccwpck_require__(604);
var DEFAULT_FULL_SCHEMA = __nccwpck_require__(134);
var DEFAULT_SAFE_SCHEMA = __nccwpck_require__(830);
...
var common              = __nccwpck_require__(156);
var YAMLException       = __nccwpck_require__(604);
var Mark                = __nccwpck_require__(980);
var DEFAULT_SAFE_SCHEMA = __nccwpck_require__(830);
var DEFAULT_FULL_SCHEMA = __nccwpck_require__(134);
...
var common        = __nccwpck_require__(156);
var YAMLException = __nccwpck_require__(604);
var Type          = __nccwpck_require__(225);
...
var Schema = __nccwpck_require__(690);


module.exports = new Schema({
  include: [
    __nccwpck_require__(395)
  ]
});
...
module.exports = Schema.DEFAULT = new Schema({
  include: [
    __nccwpck_require__(830)
  ],
  explicit: [
    __nccwpck_require__(240),
...
const github = __nccwpck_require__(774);
const resolveConfigs = __nccwpck_require__(572);
const resolveLabels = __nccwpck_require__(284);
const addUpdateLabelWeekly = __nccwpck_require__(92);
const yaml = __nccwpck_require__(59);
